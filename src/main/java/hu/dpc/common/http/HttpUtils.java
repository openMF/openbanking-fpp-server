...
public class HttpUtils {
    ...
    public static <T extends HttpResponse> T doGET(final Class<T> type, final String query,
                                                   final Map<String, String> headers) throws HTTPCallExecutionException {
        return call(HttpMethod.GET, type, query, headers, null);
    }

    @NotNull
    public static <T extends HttpResponse> T call(final HttpMethod method, final Class<T> type,
                                                  final String query, final Map<String, String> headers,
                                                  @org.jetbrains.annotations.Nullable final String body) throws HTTPCallExecutionException {
        try {
