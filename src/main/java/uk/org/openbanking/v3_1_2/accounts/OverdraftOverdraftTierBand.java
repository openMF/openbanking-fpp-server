...
public class OverdraftOverdraftTierBand {
    ...
    public int hashCode() {
        return Objects
                .hash(tierValueMax, agreementLengthMin, bankGuaranteedIndicator, tierValueMin, agreementLengthMax, agreementPeriod, EAR, overdraftInterestChargingCoverage, identification, overdraftFeesCharges, notes);
    }
