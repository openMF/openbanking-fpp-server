...
public class OBReadProduct2DataOtherProductTypeFeeChargeDetail {
    ...
    public int hashCode() {
        return Objects
                .hash(feeApplicableRange, applicationFrequency, otherFeeType, feeType, otherCalculationFrequency, feeRate, feeRateType, otherFeeCategoryType, otherApplicationFrequency, otherFeeRateType, negotiableIndicator, feeChargeCap, calculationFrequency, feeCategory, notes, feeAmount);
    }
